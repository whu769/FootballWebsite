...
#     __tablename__ = 'combined_leagues2'
...
#     xGA_diff = db.Column(db.Float)
#     NPxGA = db.Column(db.Float)
#     NPxGD = db.Column(db.Float)
#     PPDA = db.Column(db.Float)
#     OPPDA = db.Column(db.Float)
#     DC = db.Column(db.Integer)
#     ODC = db.Column(db.Integer)
#     xPTS = db.Column(db.Float)
#     xPTS_diff = db.Column(db.Float)

# class CombinedPlayer(db.Model):
#     __tablename__ = "combined_players"
#     index = db.Column(db.Integer)
#     id = db.Column(db.Integer, primary_key=True)
#     League = db.Column(db.Text)
#     player_name = db.Column(db.Text)
#     team_title = db.Column(db.Text)
...
#     npxG = db.Column(db.Float)
#     xGChain = db.Column(db.Float)
#     xGBuildup = db.Column(db.Float)
...
#     xGChain = db.Column(db.Float)
#     xGBuildup = db.Column(db.Float)
#     Gp90 = db.Column(db.Float)
#     Ap90 = db.Column(db.Float)
#     xGDiff = db.Column(db.Float)
#     xADiff = db.Column(db.Float)
#     sP90 = db.Column(db.Float)
#     kP90 = db.Column(db.Float)
#     xGChainP90 = db.Column(db.Float)
#     xGBuildupP90 = db.Column(db.Float)
...
#     tier = db.Column(db.Integer)
#     League = db.Column(db.Text)
#     teamRecommend = db.Column(db.Text)
